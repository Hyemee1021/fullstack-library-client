...
const BookLanding = () => {
  ...
  //_id is from params- getting only active reviews from server
                  ...
                  <div className="d-flex gap-3 shadow mb-4">
                    ...
                    <div className="review">
                      ...
                      <p>
                        ...
                        Consequuntur consectetur rerum hic aut alias animi
                        error, doloribus odit nam libero neque qui ipsa
                        molestiae est optio reprehenderit quasi necessitatibus
                        delectus.
                      </p>
                    </div>
                  </div>
